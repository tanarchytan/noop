...
/**
 * A detected bout's own computed avgHR/calories/maxHR/strain must fill ONLY the fields a colliding
 * real (manual/imported) workout is missing, never override anything already present. Regression for
 * manually-entered workouts silently showing no HR/calories even though the detector had already
 * computed a valid average for that exact window.
 */
