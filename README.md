...
NOOP is an independent project. What follows separates what has been **verified against a real strap**
from what is implemented but not yet exercised on hardware, because the difference matters.
