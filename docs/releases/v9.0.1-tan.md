...
This release carries a handful of fixes cherry-picked from upstream
[ryanbr/noop](https://github.com/ryanbr/noop), with thanks to **ryanbr**, **Max Schaedlich** and
**Kaveman** for the original work. NOOP-tan is an Android-only fork; where a fix helps everyone it goes
